-- GO-LIVE SEED Part 2: Loop Mappings, Indicators, Sources, and Bands (Fixed)
...
-- Create indicator registry entries (with correct triad_tag values)
...
VALUES
  ...
  ('COH.TRI',(SELECT id FROM public.loops WHERE loop_code='COH-TRI-001'),
   'TRI Cohesion Index','0–1',NULL,'institution',
  ...
  ('COH.CIVIC',(SELECT id FROM public.loops WHERE loop_code='COH-CIVIC-002'),
   'Civic Participation Rate','%',NULL,'domain',
