-- Create system user for atlas loops
INSERT INTO auth.users (
  ...
  'authenticated',
  'authenticated', 
  'atlas@ncf-pags.system',
  crypt('system-user', gen_salt('bf')),
  '{"system": true, "name": "NCF-PAGS Atlas"}',
  '{"system": true, "atlas": true}',
  now(),
  now(),
  now(),
  '',
...
-- Insert NCF-PAGS Atlas loops using the system user
