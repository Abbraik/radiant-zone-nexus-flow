...
const mockMicroLoops: MicroLoop[] = [
  {
    id: 'micro-1',
    name: 'Birth Registration Processing',
    icon: FileCheck,
    kpiValue: 3.2,
    deBandMin: 2,
    deBandMax: 5,
    status: 'healthy',
    pulseScore: 91,
    pulseTrend: [85, 87, 89, 91, 93, 91, 92, 91],
    pulseVolume: 247,
    topThemes: ['efficiency', 'accuracy', 'accessibility'],
  ...
  {
    id: 'micro-2',
    name: 'Marriage License Approval',
    icon: Heart,
    kpiValue: 4.8,
    deBandMin: 3,
    deBandMax: 7,
    status: 'healthy',
    pulseScore: 88,
    pulseTrend: [82, 84, 86, 88, 90, 89, 88, 88],
    pulseVolume: 183,
    topThemes: ['timeliness', 'documentation', 'support'],
  ...
  },
  {
    ...
    pulseVolume: 156,
    topThemes: ['accuracy', 'completeness', 'timeliness'],
  ...
  {
    id: 'micro-4',
    name: 'Environmental Permit Review',
    icon: AlertCircle,
    kpiValue: 18.5,
    deBandMin: 10,
    deBandMax: 15,
    status: 'critical',
    pulseScore: 62,
    pulseTrend: [68, 66, 64, 62, 60, 61, 62, 62],
    pulseVolume: 89,
    topThemes: ['delays', 'complexity', 'requirements'],
  ...
  },
  {
    ...
    status: 'warning',
    pulseScore: 76,
    pulseTrend: [72, 74, 76, 78, 75, 76, 77, 76],
    pulseVolume: 134,
    topThemes: ['coverage', 'accuracy', 'frequency'],
  ...
  {
    id: 'micro-6',
    name: 'Social Service Applications',
    icon: FileCheck,
    kpiValue: 5.8,
    deBandMin: 4,
    deBandMax: 8,
    status: 'healthy',
    pulseScore: 82,
    pulseTrend: [78, 80, 82, 84, 83, 82, 81, 82],
    pulseVolume: 298,
    topThemes: ['accessibility', 'fairness', 'speed'],
  ...
  },
  {
    ...
    status: 'warning',
    pulseScore: 71,
    pulseTrend: [75, 73, 71, 69, 70, 71, 72, 71],
    pulseVolume: 67,
    topThemes: ['processing time', 'documentation', 'support'],
  ...
  },
  {
    ...
    status: 'healthy',
    pulseScore: 89,
    pulseTrend: [86, 87, 89, 91, 90, 89, 88, 89],
    pulseVolume: 421,
    topThemes: ['efficiency', 'quality', 'accessibility'],
  ...
  },
  {
    ...
    status: 'warning',
    pulseScore: 74,
    pulseTrend: [70, 72, 74, 76, 75, 74, 73, 74],
    pulseVolume: 145,
    topThemes: ['complexity', 'requirements', 'guidance'],
  ...
  },
  {
    ...
    status: 'healthy',
    pulseScore: 94,
    pulseTrend: [90, 92, 94, 96, 95, 94, 93, 94],
    pulseVolume: 512,
    topThemes: ['engagement', 'responsiveness', 'transparency'],
